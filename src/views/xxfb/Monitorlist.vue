          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="会议室名称" prop="name">
                <el-input style="width: 80%" v-model="searchform.name" maxlength="128" />
              </el-form-item>
            </el-col>
            <el-col :span="6">
      ...
      <el-scrollbar height="100%">
        <div class="meetingList" v-if="meetingList.length > 0">
          <div v-for="(item, index) in meetingList" :key="index" class="meetingroom">
            <!-- <img :src="item.roomImg?('data:image/jpg;base64,'+item.roomImg):'@/assets/xxfb/screenshots/13.png'" @click="gotomonitorList(item)" /> -->

            <img src="@/assets/xxfb/screenshots/13.png" @click="gotomonitorList(item)" />
...
const getList = () => {
  request
    ...
    .then((res) => {
      ...
      //使用push方法:结构后再赋值
      meetingList.value.push(...res.data.data)
    })
    .catch((error) => {
