<template>
    <div style="margin: 0 auto;" class="userList">
        <el-container>
            <el-header style="height: 90px;">
                ...
                <el-button type="primary" :class="['addBtn',selectRows.length>0?'addBtnActive':'']" @click="addBtn" :disabled="selectRows.length>0">
                    新增分类
                </el-button>
                <el-button type="danger" :class="['delBtn',selectRows.length>0?'delBtnActive':'']" :disabled="selectRows.length<=0" @click="deleteBtn">
                    删除
                </el-button>
            </el-header>
            <el-main>
                <div>
                    ...
                    >
                        ...
                        <el-table-column prop="classificationName" label="名称">
                           <template #default="scope">
                                ...
                                <template v-if="scope.row.type==2"> 
                                  <a :href="scope.row.publishPath" target="_blank">{{scope.row.childficationName}}</a>
                                </template>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="操作">
                            <template #default="scope">
                                <template v-if="scope.row.type==1">
                                    <span  style="color: #1890FF;font-size: 14px;cursor: pointer;" @click="handleEdit( scope.row)">修改&nbsp;&nbsp;</span>
                                      
                                    <span  style="color: #1890FF;font-size: 14px;cursor: pointer;" @click="addPageBtn( scope.row)">新增页面</span>
                                </template>
                                <template v-if="scope.row.type==2">
                                    <span  style="color: #1890FF;font-size: 14px;cursor: pointer;" @click="handlePageEdit( scope.row)">修改&nbsp;&nbsp;</span>
                                      
                                    <a  style="color: #1890FF;font-size: 14px;cursor: pointer;"  :href="scope.row.processEditPath" target="_blank">
                                   编辑
                                </a>
                                </template>
    ...
    >
        <el-form :model="addForm" label-width="100px" ref="createFormRef" :rules="createFormRules">
            ...
            <el-form-item>
                <el-button v-if="type=='add'" type="primary"  @click="addMeetingCategory">确 定</el-button>
                <el-button type="primary" v-if="type=='update'" @click="updateMeetingCategory">确 定</el-button>
    ...
    <el-dialog
            ...
            style="width: 400px;"
    >
        <el-form :model="addPageForm" label-width="100px" ref="createPageFormRef" :rules="createPageFormRules">
            ...
            <el-form-item>
                <el-button type="primary" v-if="pagetype=='add'" @click="addMeetingPage">确 定</el-button>
                <el-button type="primary" v-if="pagetype=='update'" @click="updateMeetingPage">确 定</el-button>
