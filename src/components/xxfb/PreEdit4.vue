        ...
        >
          <el-carousel-item v-for="(item, i) in mediaAreaList" :key="i">
            ...
            <template v-else>
              ...
              ></video>
              <!-- <el-button v-else loading style="border: 0px;position: absolute;transform: translate(303px,180px);background-color: transparent;font-size: 60px;color: #333;" color='#222' ></el-button> -->
