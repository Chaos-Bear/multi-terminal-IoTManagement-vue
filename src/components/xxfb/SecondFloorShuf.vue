          ...
          <div class="left">
            ...
            <div class="left2">
              ...
              <div class="left2-2">
                <div>
                  <div>
                    <div id="A2225" data-roomName="A2225" @click="dataRoomClick('A2225')">
                      A2-225
                    </div>
                    <!-- 横 双排门 -->
                  ...
                  <div>
                    <div id="A2226" data-roomName="A2226" @click="dataRoomClick('A2226')">
                      A2-226
                    </div>
                    <!-- 横 双排门 -->
                    <img class="doubledoor" src="@/assets/xxfb/path/6.png" />
          ...
          <div class="right">
            ...
            <div class="right4">
              ...
              <div class="right4-1">
                ...
                <div>
                  <div id="A2211" data-roomName="A2211" @click="dataRoomClick('A2211')">A2-211</div>
                  <!-- 竖双门 -->
                  <img class="hdoubledoor" src="@/assets/xxfb/path/7.png " />
                  <!-- 竖双门 -->
                  <img class="hdoubledoor" src="@/assets/xxfb/path/7.png " />
